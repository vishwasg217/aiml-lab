def aStarAlgo(start_node, stop_node):
    ...
    while len(open_set) > 0 :
        ...
        # this for loop is to find the closest node
        ...
        if n == stop_node or Graph_nodes[n] == None:
            ...
            # if the neighbour node is not in the open set and closed_set, add it to the open_set and set its parent node to current node
